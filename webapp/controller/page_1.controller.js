sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("generated.app.controller.page_1", {
		...
		onAfterShow: function() {
			console.log("UI loaded - Screen 1");
		
			var surveyResults = new sap.ui.model.json.JSONModel();
			
			var sValue = jQuery.sap.getUriParameters().get("surveyID");
			surveyResults.surveyID = sValue;
			
			var pageTitle = this.getView().byId("page1Title");
			if ( sValue != null) {
				pageTitle.setTitle( pageTitle.getTitle() + " - ID: " + sValue );
			}
			//this.getView().byId("surveyID").setText("Survey ID:"+sValue);
